...
- [ ] I listed every external paper, specification, API document, dataset,
      model, checkpoint, fixture, or code artifact consulted below.
...
- [ ] I followed `CLEAN_ROOM.md` and `PROVENANCE_POLICY.md` and did not use
      placeholder ids, digests, results, attestations, or fabricated Kaname
      history.
